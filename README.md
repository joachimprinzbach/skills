...
| Skill | What it does |
|---|---|
| [`grill-me-joachim`](./skills/grill-me-joachim/SKILL.md) | An honest, craft-driven code/design review in Joachim's voice — Clean Code + Ousterhout, calibrated to a pragmatism dial, with prioritised findings (Blocker / Sollte / Zur Überlegung / Nit). |
